...
<body>
	...
	<ul>
		...
		<li><a href="EditTheatre">Edit Theatre</a></li>
		<li><a href="DeleteTheatre">Delete Theatre</a></li>
			...
			<table>
				...
				<tr>
					...
					<td><input type="number" id="ReservationCapacityRegular"
						name="ReservationCapacityRegular" required></td>
				</tr>
				<tr>
					<td colspan="2">
