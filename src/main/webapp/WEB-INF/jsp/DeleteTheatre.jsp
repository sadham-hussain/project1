...
<body>
	...
	<nav>
		<form action="AddTheatre" action="GET">
			<button type="submit">Theatres</button>
		</form>
		<form action="AddMovie" action="GET">
			<button type="submit">Movies</button>
		</form>
		<form action="AddShow" method="GET">
	...
	<div>
		<form action="DeleteTheatreListReload" method="GET">
			<table>
				<tr>
		...
		<form action="DeleteTheatre" method="POST">
			<table>
				...
				<tr>
					...
					<td><label for="NumberOfShows">:${NumberOfShows}</label></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><label for="ReservationCapacityRegular">:${ReservationCapacityRegular}</label></td>
				</tr>
				<tr>
					<td colspan="2">
